		...
		<footer class="footer">
			<div class="inner">
				...
				<ul class="footer-sns clearfix">
					<li><a href="#"><img src="@/assets/images/f_sns_1.png" alt="블로그"></a></li>
					<li><a href="#"><img src="@/assets/images/f_sns_2.png" alt="인스타"></a></li>
					<li><a href="#"><img src="@/assets/images/f_sns_3.png" alt="페이스북"></a></li>
				</ul>
